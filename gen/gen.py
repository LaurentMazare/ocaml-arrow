...
class Type(object):
  def __init__(self, type_, arg=None):
    ...
    if base_type is not None:
      ...
      return
    self._base = False
    if arg is not None and t == 'glist':
    ...
    if t == 'interface':
      ...
      if t not in unsupported_types:
        ...
        self._c = t
        return
    raise ValueError('unhandled type %s %s %s' % (type_, t, arg))
...
def write_files(f_c, f_ml, f_mli):
  ...
  f_ml.write('  Gc.finalise C.GList.free res;\n')
  f_ml.write('  res\n\n')

  f_mli.write('(* THIS FILE IS AUTOMATICALLY GENERATED, DO NOT EDIT! *)\n\n')
  f_mli.write('type (-\'a) gobject\n\n')
