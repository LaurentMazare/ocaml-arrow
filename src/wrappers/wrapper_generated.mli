...
module BufferInputStream : sig
  ...
  val parent : t -> seekable_input_stream
  val new_ : buffer -> t
  val get_buffer : t -> buffer
end
...
module Decimal128Array : sig
  ...
  val parent : t -> fixed_size_binary_array
...
module DoubleDataType : sig
  ...
  val parent : t -> floating_point_data_type
  val new_ : unit -> t
end
...
module FloatingPointDataType : sig
  ...
  val parent : t -> numeric_data_type
end
...
module Int16DataType : sig
  ...
  val parent : t -> integer_data_type
  val new_ : unit -> t
end
...
module RecordBatchFileWriter : sig
  ...
  val parent : t -> record_batch_stream_writer
...
module RecordBatchStreamReader : sig
  ...
  val parent : t -> record_batch_reader
  val new_ : input_stream -> t
end
...
module RecordBatchStreamWriter : sig
  ...
  val parent : t -> record_batch_writer
  val new_ : output_stream -> schema -> t
end
...
module StringArrayBuilder : sig
  ...
  val parent : t -> binary_array_builder
  val new_ : unit -> t
