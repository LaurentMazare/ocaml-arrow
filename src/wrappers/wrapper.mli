...
module Array : sig
  ...
  val cast : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [< `binary_data_type | `date32_data_type | `date64_data_type | `fixed_width_data_type | `list_data_type | `null_data_type | `string_data_type | `struct_data_type | `time_data_type | `timestamp_data_type | `union_data_type | `data_type ] gobject -> [< `cast_options ] gobject -> [ `array_ ] gobject
  val count : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [< `count_options ] gobject -> Int64.t
  val count_values : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [ `struct_array ] gobject
  val dictionary_encode : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [ `dictionary_array ] gobject
  val equal : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> bool
  val equal_approx : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> bool
  val equal_range : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> Int64.t -> [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> Int64.t -> Int64.t -> bool
  val get_length : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> Int64.t
  val get_n_nulls : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> Int64.t
  val get_null_bitmap : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [ `buffer ] gobject
  val get_offset : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> Int64.t
  val get_value_data_type : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [ `data_type ] gobject
  val is_null : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> Int64.t -> bool
  val is_valid : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> Int64.t -> bool
  val slice : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> Int64.t -> Int64.t -> [ `array_ ] gobject
  val to_string : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> string
  val unique : [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [ `array_ ] gobject
end

module ArrayBuilder : sig
  type t = [ `array_builder ] gobject

  val finish : [< `binary_array_builder | `boolean_array_builder | `date32_array_builder | `date64_array_builder | `decimal128_array_builder | `double_array_builder | `float_array_builder | `int16_array_builder | `int32_array_builder | `int64_array_builder | `int8_array_builder | `int_array_builder | `list_array_builder | `null_array_builder | `struct_array_builder | `time32_array_builder | `time64_array_builder | `timestamp_array_builder | `u_int16_array_builder | `u_int32_array_builder | `u_int64_array_builder | `u_int8_array_builder | `u_int_array_builder | `array_builder ] gobject -> [ `array_ ] gobject
  val get_value_data_type : [< `binary_array_builder | `boolean_array_builder | `date32_array_builder | `date64_array_builder | `decimal128_array_builder | `double_array_builder | `float_array_builder | `int16_array_builder | `int32_array_builder | `int64_array_builder | `int8_array_builder | `int_array_builder | `list_array_builder | `null_array_builder | `struct_array_builder | `time32_array_builder | `time64_array_builder | `timestamp_array_builder | `u_int16_array_builder | `u_int32_array_builder | `u_int64_array_builder | `u_int8_array_builder | `u_int_array_builder | `array_builder ] gobject -> [ `data_type ] gobject
end
...
module BinaryArray : sig
  ...
  val new_ : Int64.t -> [< `mutable_buffer | `buffer ] gobject -> [< `mutable_buffer | `buffer ] gobject -> [< `mutable_buffer | `buffer ] gobject -> Int64.t -> t
  val get_buffer : [< `string_array | `binary_array ] gobject -> [ `buffer ] gobject
  val get_offsets_buffer : [< `string_array | `binary_array ] gobject -> [ `buffer ] gobject
end
...
module BinaryArrayBuilder : sig
  ...
  val new_ : unit -> t
  val append_null : [< `string_array_builder | `binary_array_builder ] gobject -> bool
end
...
module BooleanArray : sig
  ...
  val new_ : Int64.t -> [< `mutable_buffer | `buffer ] gobject -> [< `mutable_buffer | `buffer ] gobject -> Int64.t -> t
  val and_ : [< `boolean_array ] gobject -> [< `boolean_array ] gobject -> [ `boolean_array ] gobject
  val get_value : [< `boolean_array ] gobject -> Int64.t -> bool
  val invert : [< `boolean_array ] gobject -> [ `boolean_array ] gobject
  val or_ : [< `boolean_array ] gobject -> [< `boolean_array ] gobject -> [ `boolean_array ] gobject
  val xor : [< `boolean_array ] gobject -> [< `boolean_array ] gobject -> [ `boolean_array ] gobject
end
...
module Buffer : sig
  ...
  val copy : [< `mutable_buffer | `buffer ] gobject -> Int64.t -> Int64.t -> [ `buffer ] gobject
  val equal : [< `mutable_buffer | `buffer ] gobject -> [< `mutable_buffer | `buffer ] gobject -> bool
  val equal_n_bytes : [< `mutable_buffer | `buffer ] gobject -> [< `mutable_buffer | `buffer ] gobject -> Int64.t -> bool
  val get_capacity : [< `mutable_buffer | `buffer ] gobject -> Int64.t
  val get_parent : [< `mutable_buffer | `buffer ] gobject -> [ `buffer ] gobject
  val get_size : [< `mutable_buffer | `buffer ] gobject -> Int64.t
  val is_mutable : [< `mutable_buffer | `buffer ] gobject -> bool
  val slice : [< `mutable_buffer | `buffer ] gobject -> Int64.t -> Int64.t -> [ `buffer ] gobject
end
...
module BufferInputStream : sig
  ...
  val new_ : [< `mutable_buffer | `buffer ] gobject -> t
...
module CSVReader : sig
  ...
  val new_ : [< `compressed_input_stream | `input_stream | `seekable_input_stream | `input_stream ] gobject -> [< `csv_read_options ] gobject -> t
...
module Column : sig
  ...
  val new_array : [< `field ] gobject -> [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> t
...
module CompressedInputStream : sig
  ...
  val new_ : [< `codec ] gobject -> [< `compressed_input_stream | `input_stream | `seekable_input_stream | `input_stream ] gobject -> t
end
...
module CompressedOutputStream : sig
  ...
  val parent : t -> [ `output_stream ] gobject
  val new_ : [< `codec ] gobject -> [< `buffer_output_stream | `compressed_output_stream | `file_output_stream | `gio_output_stream | `output_stream ] gobject -> t
end
...
module DataType : sig
  ...
  val equal : [< `binary_data_type | `date32_data_type | `date64_data_type | `fixed_width_data_type | `list_data_type | `null_data_type | `string_data_type | `struct_data_type | `time_data_type | `timestamp_data_type | `union_data_type | `data_type ] gobject -> [< `binary_data_type | `date32_data_type | `date64_data_type | `fixed_width_data_type | `list_data_type | `null_data_type | `string_data_type | `struct_data_type | `time_data_type | `timestamp_data_type | `union_data_type | `data_type ] gobject -> bool
  val to_string : [< `binary_data_type | `date32_data_type | `date64_data_type | `fixed_width_data_type | `list_data_type | `null_data_type | `string_data_type | `struct_data_type | `time_data_type | `timestamp_data_type | `union_data_type | `data_type ] gobject -> string
end
...
module DecimalDataType : sig
  ...
  val get_precision : [< `decimal128_data_type | `decimal_data_type ] gobject -> Int32.t
  val get_scale : [< `decimal128_data_type | `decimal_data_type ] gobject -> Int32.t
end
...
module DictionaryArray : sig
  ...
  val parent : t -> [ `array_ ] gobject
  val new_ : [< `binary_data_type | `date32_data_type | `date64_data_type | `fixed_width_data_type | `list_data_type | `null_data_type | `string_data_type | `struct_data_type | `time_data_type | `timestamp_data_type | `union_data_type | `data_type ] gobject -> [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> t
  val get_dictionary : [< `dictionary_array ] gobject -> [ `array_ ] gobject
  val get_dictionary_data_type : [< `dictionary_array ] gobject -> [ `dictionary_data_type ] gobject
...
module DictionaryDataType : sig
  ...
  val parent : t -> [ `fixed_width_data_type ] gobject
  val new_ : [< `binary_data_type | `date32_data_type | `date64_data_type | `fixed_width_data_type | `list_data_type | `null_data_type | `string_data_type | `struct_data_type | `time_data_type | `timestamp_data_type | `union_data_type | `data_type ] gobject -> [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> bool -> t
...
module FeatherFileReader : sig
  ...
  val new_ : [< `buffer_input_stream | `gio_input_stream | `memory_mapped_input_stream | `seekable_input_stream ] gobject -> t
...
module FeatherFileWriter : sig
  ...
  val new_ : [< `buffer_output_stream | `compressed_output_stream | `file_output_stream | `gio_output_stream | `output_stream ] gobject -> t
  val append : [< `feather_file_writer ] gobject -> string -> [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> bool
...
module Field : sig
  ...
  val new_ : string -> [< `binary_data_type | `date32_data_type | `date64_data_type | `fixed_width_data_type | `list_data_type | `null_data_type | `string_data_type | `struct_data_type | `time_data_type | `timestamp_data_type | `union_data_type | `data_type ] gobject -> t
  val new_full : string -> [< `binary_data_type | `date32_data_type | `date64_data_type | `fixed_width_data_type | `list_data_type | `null_data_type | `string_data_type | `struct_data_type | `time_data_type | `timestamp_data_type | `union_data_type | `data_type ] gobject -> bool -> t
...
module FixedSizeBinaryDataType : sig
  ...
  val parent : t -> [ `fixed_width_data_type ] gobject
  val new_ : Int32.t -> t
  val get_byte_width : [< `decimal_data_type | `fixed_size_binary_data_type ] gobject -> Int32.t
end
...
module FixedWidthDataType : sig
  ...
  val parent : t -> [ `data_type ] gobject
  val get_bit_width : [< `boolean_data_type | `dictionary_data_type | `fixed_size_binary_data_type | `numeric_data_type | `fixed_width_data_type ] gobject -> Int32.t
end
...
module GIOInputStream : sig
  ...
  val parent : t -> [ `seekable_input_stream ] gobject
  val new_ : [< `compressed_input_stream | `input_stream | `seekable_input_stream | `input_stream ] gobject -> t
end
...
module InputStream : sig
  ...
  val parent : t -> [ `input_stream ] gobject
  val advance : [< `compressed_input_stream | `input_stream | `seekable_input_stream | `input_stream ] gobject -> Int64.t -> bool
  val align : [< `compressed_input_stream | `input_stream | `seekable_input_stream | `input_stream ] gobject -> Int32.t -> bool
  val read_tensor : [< `compressed_input_stream | `input_stream | `seekable_input_stream | `input_stream ] gobject -> [ `tensor ] gobject
end
...
module ListArray : sig
  ...
  val parent : t -> [ `array_ ] gobject
  val new_ : [< `binary_data_type | `date32_data_type | `date64_data_type | `fixed_width_data_type | `list_data_type | `null_data_type | `string_data_type | `struct_data_type | `time_data_type | `timestamp_data_type | `union_data_type | `data_type ] gobject -> Int64.t -> [< `mutable_buffer | `buffer ] gobject -> [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [< `mutable_buffer | `buffer ] gobject -> Int64.t -> t
...
module MutableBuffer : sig
  ...
  val slice : [< `resizable_buffer | `mutable_buffer ] gobject -> Int64.t -> Int64.t -> [ `mutable_buffer ] gobject
end
...
module NumericArray : sig
  ...
  val parent : t -> [ `primitive_array ] gobject
  val mean : [< `date32_array | `date64_array | `double_array | `float_array | `int16_array | `int32_array | `int64_array | `int8_array | `time32_array | `time64_array | `timestamp_array | `u_int16_array | `u_int32_array | `u_int64_array | `u_int8_array | `numeric_array ] gobject -> float
end
...
module OutputStream : sig
  ...
  val align : [< `buffer_output_stream | `compressed_output_stream | `file_output_stream | `gio_output_stream | `output_stream ] gobject -> Int32.t -> bool
  val write_tensor : [< `buffer_output_stream | `compressed_output_stream | `file_output_stream | `gio_output_stream | `output_stream ] gobject -> [< `tensor ] gobject -> Int64.t
end
...
module PrimitiveArray : sig
  ...
  val parent : t -> [ `array_ ] gobject
  val get_buffer : [< `boolean_array | `fixed_size_binary_array | `numeric_array | `primitive_array ] gobject -> [ `buffer ] gobject
end

module RecordBatch : sig
  type t = [ `record_batch ] gobject

  val add_column : [< `record_batch ] gobject -> Unsigned.uint32 -> [< `field ] gobject -> [< `binary_array | `dictionary_array | `list_array | `null_array | `primitive_array | `struct_array | `union_array | `array_ ] gobject -> [ `record_batch ] gobject
...
module RecordBatchFileWriter : sig
  ...
  val new_ : [< `buffer_output_stream | `compressed_output_stream | `file_output_stream | `gio_output_stream | `output_stream ] gobject -> [< `schema ] gobject -> t
end

module RecordBatchReader : sig
  type t = [ `record_batch_reader ] gobject

  val get_schema : [< `record_batch_stream_reader | `table_batch_reader | `record_batch_reader ] gobject -> [ `schema ] gobject
  val read_next : [< `record_batch_stream_reader | `table_batch_reader | `record_batch_reader ] gobject -> [ `record_batch ] gobject
end
...
module RecordBatchWriter : sig
  ...
  val close : [< `record_batch_stream_writer | `record_batch_writer ] gobject -> bool
  val write_record_batch : [< `record_batch_stream_writer | `record_batch_writer ] gobject -> [< `record_batch ] gobject -> bool
  val write_table : [< `record_batch_stream_writer | `record_batch_writer ] gobject -> [< `table ] gobject -> bool
end
...
module SeekableInputStream : sig
  ...
  val parent : t -> [ `input_stream ] gobject
  val get_size : [< `buffer_input_stream | `gio_input_stream | `memory_mapped_input_stream | `seekable_input_stream ] gobject -> Unsigned.uint64
  val get_support_zero_copy : [< `buffer_input_stream | `gio_input_stream | `memory_mapped_input_stream | `seekable_input_stream ] gobject -> bool
  val read_at : [< `buffer_input_stream | `gio_input_stream | `memory_mapped_input_stream | `seekable_input_stream ] gobject -> Int64.t -> Int64.t -> [ `buffer ] gobject
end
...
module Time32Array : sig
  ...
  val parent : t -> [ `numeric_array ] gobject
  val new_ : [< `time32_data_type ] gobject -> Int64.t -> [< `mutable_buffer | `buffer ] gobject -> [< `mutable_buffer | `buffer ] gobject -> Int64.t -> t
...
module Time64Array : sig
  ...
  val parent : t -> [ `numeric_array ] gobject
  val new_ : [< `time64_data_type ] gobject -> Int64.t -> [< `mutable_buffer | `buffer ] gobject -> [< `mutable_buffer | `buffer ] gobject -> Int64.t -> t
...
module TimestampArray : sig
  ...
  val parent : t -> [ `numeric_array ] gobject
  val new_ : [< `timestamp_data_type ] gobject -> Int64.t -> [< `mutable_buffer | `buffer ] gobject -> [< `mutable_buffer | `buffer ] gobject -> Int64.t -> t
...
module UnionArray : sig
  ...
  val parent : t -> [ `array_ ] gobject
  val get_field : [< `dense_union_array | `sparse_union_array | `union_array ] gobject -> Int32.t -> [ `array_ ] gobject
end
...
module UnionDataType : sig
  ...
  val parent : t -> [ `data_type ] gobject
  val get_field : [< `dense_union_data_type | `sparse_union_data_type | `union_data_type ] gobject -> Int32.t -> [ `field ] gobject
  val get_n_fields : [< `dense_union_data_type | `sparse_union_data_type | `union_data_type ] gobject -> Int32.t
end
